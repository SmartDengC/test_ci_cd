...
public class test {
    public static void main(String args[]) throws FileNotFoundException {
        File file = new File("C:/Users/Lenovo/Desktop/生源分析系统/生源分析系统原始数据/2015data/四川/11079aa/TD_KSLXDM.dbf");
        ...
        System.out.print(a.insertTD_KSLXDM(data,2019,1).get(1).getKSLXMC());
    }
}
